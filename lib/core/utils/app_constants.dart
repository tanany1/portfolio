...
abstract class AppConstants {
  ...
  static const List<CustomService> services = [
    ...
    CustomService(
        ...
        description: 'Firebase (Auth, Firestore, Realtime DB, Storage)\n'
  ...
  static const List<Project> projects = [
    ...
    Project(
      name: 'NFC Manager',
      imageUrl: '',
      description: 'Read/write mobile app to manage NFC cards.',
    ...
    Project(
      name: 'Islami App',
      imageUrl: '',
      description: 'Daily Islamic tools and resources.',
      githubRepoLink: 'https://github.com/tanany1/Islami-app.git',
    ),
    Project(
      name: 'Todo App',
      imageUrl: '',
      description: 'Task manager with full CRUD operations.',
      githubRepoLink: 'https://github.com/tanany1/ToDo-App.git',
    ),
    Project(
      name: 'News App',
      imageUrl: '',
      description: 'Categorized news fetching and display via API.',
      githubRepoLink: 'https://github.com/tanany1/news_app.git',
    ),
    Project(
      name: 'Movies App',
      imageUrl: '',
      description: 'App to search and browse movies with detailed views.',
